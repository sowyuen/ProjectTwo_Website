                ...
                <div className="border border-warning justify-content-center borderAdd">
                  ...
                  <form method="POST" action="/kaching/register">
                        ...
                        <div className="form-check-inline">
                              ...
                              <input type="radio" className="form-check-input" name="food"/><img src="https://png.pngtree.com/svg/20170208/be6783b29c.png" width="35" height="35" alt="Kaching!"/> Food
                              </label>
                                </div>
                                <div className="form-check-inline">
                                  <label className="form-check-label">
                                  <input type="radio" className="form-check-input" name="transport"/><img src="https://cdn4.iconfinder.com/data/icons/transportation-lineal-color-set-version-two/512/Transport_Bus_Lineal_Color-512.png" width="35" height="35" alt="Kaching!"/> Transport
                                  </label>
                                </div>
                                <div className="form-check-inline">
                                  <label className="form-check-label">
                                  <input type="radio" className="form-check-input" name="bills"/><img src="https://image.flaticon.com/icons/png/512/1365/1365895.png" width="35" height="35" alt="Kaching!"/> Bills
                                  </label>
                                </div>
                                <div className="form-check-inline">
                                  <label className="form-check-label">
                                  <input type="radio" className="form-check-input" name="entertainment"/><img src="https://cdn1.iconfinder.com/data/icons/news-and-media-solid-the-world-today/512/Entertainment_News-512.png" width="35" height="35" alt="Kaching!"/> Entertainment
                                  </label>
                                </div>
                                <div className="form-check-inline">
                                  <label className="form-check-label">
                                  <input type="radio" className="form-check-input" name="others"/><img src="/kaching.png" width="35" height="35" alt="Kaching!"/> Others
                                  </label>
                                </div>
